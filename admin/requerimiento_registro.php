    ...
    <body class="skin-blue fixed">
					...
					<div class="row">
						<div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form action="requerimiento_registro_insertar.php" method="post">
                                    <div class="box-body">
										<div class="row">
											<div class="col-xs-6">
											...
											<div class="col-xs-6">
												<input type="number" class="form-control" placeholder="# de Unidades" name="unidades" maxlength="2" required min="1" max="20"/>
											</div>
										</div><br>
										<div class="form-group">
                                            <label>Notas</label>
                                            <textarea class="form-control" rows="3" name="notas" placeholder="Notas ..."></textarea>
                                        </div>
                                    </div><!-- /.box-body -->
									<input name="idcentro" type="hidden" value="<?php echo $s_idcentro ?>" >	
									<input name="idusuario" type="hidden" value="<?php echo $s_idusuario ?>" >	
                                ...
                                <div class="box-header">
                                 ...
                                 <div class="box-body table-responsive no-padding">
                                    <table id="example1" class="table table-hover">
                                        ...
                                        <tbody>
										<?php
											$query = "SELECT * FROM requerimientos where idcentro='$s_idcentro' order by fecha desc limit 5 ";
		...
		<div class="alerta">
			<div class="alert alert-success alert-dismissable">
                ...
                <b>Alerta!</b> Requerimiento registrado
            </div>
		</div>
		<?php } ?>
