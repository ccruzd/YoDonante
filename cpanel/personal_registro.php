    ...
    <body class="skin-blue fixed">
					...
					<div class="row">
						<div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form action="personal_registro_insertar.php" method="post">
									<div class="box-body">
										<div class="form-group">
                                            <label>Centro</label>
                                            <select class="form-control" name="centro">
                                                <?php
												$result=mysql_query("select * from centros where bancosangre='1' order by nombre asc");
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Nombres y Apellidos" name="nombre" maxlength="100" required/>
                                        </div>
										<div class="form-group">
										...
										<div class="row">
											<div class="col-xs-6">
												<input type="text" class="form-control" placeholder="Usuario" name="usuario" id="usuario" maxlength="100" required/>
												<div id="resultado"></div>
											</div>
											<div class="col-xs-6">
												<input type="text" class="form-control" placeholder="Password" name="password" maxlength="100" required/>
											</div>
										</div>
                                    </div><!-- /.box-body -->
						...
						<div class="col-md-6">
							<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Últimos 5 registros</h3>
                                </div><!-- /.box-header -->
                                 <div class="box-body table-responsive no-padding">
                                    <table id="example1" class="table table-hover">
                                        ...
                                        <tbody>
										<?php
											$query = "SELECT * FROM personal order by fecha desc limit 5";
											$rs = mysql_query($query);
											while($rsconsulta = mysql_fetch_array($rs)) {
										?>
                                            <tr>
												<td><?php echo $rsconsulta['idcentro'] ?></td>
		...
		<div class="alerta">
			<div class="alert alert-success alert-dismissable">
                ...
                <b>Alerta!</b> Registro Exitoso: <?php echo $desc; ?>
            </div>
		</div>
		<?php } ?>
