                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
										...
										?>
                                            <tr>
												<td><?php echo $rsconsulta['id'] ?></td>
                                                <td><?php echo $rsconsulta['nombre'] ?></td>
                                                <td><?php echo $rsconsulta['departamento'] ?></td>
                                                <td><?php echo $rsconsulta['distrito'] ?></td>
                                                <td><?php echo $rsconsulta['ubigeo'] ?></td>
                                                <td><?php echo $rsconsulta['direccion'] ?></td>
                                                <td><?php echo $rsconsulta['categoria'] ?></td>
												<td><?php if ($rsconsulta['bancosangre']=="1") { ?>
