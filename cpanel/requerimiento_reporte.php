                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
										<?php
										$query = "SELECT R.id, R.idcentro, R.tiposangre, R.unidades, R.fecha, R.idusuario, R.notas, R.codigo, R.estado, C.nombre as nombrecentro, P.username  
										...
										?>
                                            <tr>
												<td><?php echo $rsconsulta['nombrecentro'] ?></td>
												...
												<div class="btn-group" align="right">
													...
													<ul class="dropdown-menu" role="menu">
														<li><a data-toggle="modal" data-target="#compose-modal<?php echo $rsconsulta['id'] ?>"><i class="fa fa-desktop"></i>Ver</a></li>
														<li><a href="bautizo_registro_upd.php?id=<?php echo $rsconsulta['id'] ?>"><i class="fa fa-pencil"></i>Modificar</a></li>
														<li><a href="../pdf/reporte/bautizo.php?id=<?php echo $rsconsulta['id'] ?>" target="_blank" ><i class="fa fa-file-o"></i>Reporte</a></li>
														<li class="divider"></li>
														<li><a href="bautizo_registro_delete.php?type=<?php echo $type; ?>&search=<?php echo $search; ?>&id=<?php echo $rsconsulta['id'] ?>"><i class="fa fa-trash-o"></i>Eliminar</a></li>
													</ul>
												</div>
                                            </tr>
